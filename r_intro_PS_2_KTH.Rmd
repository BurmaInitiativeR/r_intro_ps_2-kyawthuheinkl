...
```{r meanseris}
mean_seris <- list(means_list_1, means_list_2, means_list_3, means_list_4, means_list_5)

means_list_x <- c("means_list_1" = mean(mean_seris[[1]][[2]]),
                    "means_list_2" = mean(mean_seris[[2]][[2]]),
                    "means_list_3" = mean(mean_seris[[3]][[2]]),
                    "means_list_4" = mean(mean_seris[[4]][[2]]),
                    "means_list_5" = mean(mean_seris[[5]][[2]]))
means_list_x

```
```{r groupby test}
df_means_combined <- bind_rows(mean_seris)
